...
from AttnGan.miscc.GlobalAttention import GlobalAttentionGeneral as ATT_NET
...
class RNN_ENCODER(nn.Module):
    ...
    def init_weights(self):
        ...
        # self.decoder.weight.pretrained.uniform_(-initrange, initrange)
        # self.decoder.bias.pretrained.fill_(0)
